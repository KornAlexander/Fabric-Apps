...
| <img src="docs/previews/muenchen-zwilling.webp" width="220" alt="Munich Twin (München Zwilling) preview"> | **[Munich Twin (München Zwilling)](industry/muenchen-zwilling/)** | Munich city centre and airport as one 1:1 3D twin with live open-data layers, a tool-calling assistant and shared coordination notes. |
...
*17 apps. This table is generated by `tools/generate_index.py` from each app's `package.json` — edit the app, not the table.*
