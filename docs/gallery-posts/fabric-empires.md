...
- Playable in the browser right now: no install, no sign-in, works on a phone
...
The exam skills outlines are public. Nothing about a candidate, a score or an attempt is collected or stored.
