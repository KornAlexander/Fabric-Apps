...
// Repo-relative, and already gitignored. This was an absolute path into one developer's home
// directory: it wrote nothing useful on any other machine, and published that directory layout to
// a public gallery template.
