 ...
 *
 * The pipeline output is around 31 MB — a terrain heightmap, a flow field and a LoD2 building
 * mesh — and it is not committed. A freshly scaffolded copy of this template therefore has no
 * terrain on first run. That is expected, so the app explains how to produce it rather than
