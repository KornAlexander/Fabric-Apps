...
# CSV in OneLake Files -> Delta table name. Names follow the §8.2 schema, flattened because the
# lakehouse is not schema-enabled (a schema folder would break Direct Lake partition resolution —
# see /memories/fabric_rest_api.md).
TABLES = {
    "geo_building": "curated/geo_building.csv",
    "portfolio_policy": "curated/portfolio_policy.csv",
    "claims_claim": "curated/claims_claim.csv",
}
