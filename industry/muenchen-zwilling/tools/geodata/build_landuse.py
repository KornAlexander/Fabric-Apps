...
def main() -> None:
    ...
    # second site painted the FIRST site's polygons onto its own grid
    ...
    meta_path = out_dir / "heightmap.json"
    ...
    # value, so 2 m compresses about 27:1
