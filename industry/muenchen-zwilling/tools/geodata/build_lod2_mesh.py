...
def write_roof_colours(
    ...
    return {
        ...
        "wallsAreNotMeasured": (
            ...
            "function code, its measured size and, where the site operator is tagged, the "
...
def main() -> None:
    ...
    places = [
        (*wgs84_to_utm(p["lon"], p["lat"]), p["name"])
    ...
    for path in tiles:
        ...
        for building in root.iter(f"{{{NS['bldg']}}}Building"):
            ...
            # then roofs, and ONE index per building says where the roofs start
            ...
            # orthophoto can be sampled per SURFACE as well as per building
    ...
    # Quantise. float32 is far more precision than a building corner has
        ...
        json.dumps(
            {
                ...
                "wallClasses": {
                    ...
                    "basis": (
                        ...
                        "a large share of an institutional site is tagged 31001_9998 "
                        "'unspecified' while carrying a clearly institutional building name. "
                        "The CLASS is measured; the colour it is painted is a convention."
                    ),
                },
