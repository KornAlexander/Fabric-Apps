...
def tile_grid(cfg: dict, tier: Tier, tile_km: int) -> list[tuple[int, int]]:
    ...
    min_e, min_n, max_e, max_n = bbox_to_utm(west, south, east, north)
...
def fetch_tile(
    ...
    for attempt in range(attempts):
        ...
        try:
            ...
            # 404 means this square is genuinely outside Bavaria
...
def main() -> None:
    ...
    if args.metalink:
        try:
            ...
            # An unusable catalogue must not stop the download
