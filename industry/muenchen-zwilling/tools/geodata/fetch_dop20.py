...
def main() -> None:
    ...
    # failed to complete the mipmap chain, and every sample came back BLACK
    ...
    #
    # ⚠️ The same argument applies to the shell, against `shell.json`
