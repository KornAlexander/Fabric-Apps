...
#:
#: ⚠️ This was 1.12 and the result looked like a doll's house
...
#: so a threshold calibrated on well-sampled large roofs is pure noise on small ones
...
#: therefore leaning on the sun again, one step removed
...
#: for the one case hue cannot express
#: no meaningful hue at all
#: it.
